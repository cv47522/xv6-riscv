...
| **[04-terminology.md](04-terminology.md)**                       | Glossary. Every acronym expanded — xv6, RISC-V, QEMU, hart, PLIC, ISO C, POSIX, GNU, and the rest.                                                                                                                                                                                                                                                                         |
...
| **[labs/](labs/)**                                               | One note per MIT lab exercise that needs derivation rather than transcription: the handout's requirements, the existing code it forces you to read, and a decision checklist. Contains no solutions. Currently: the `util` lab's `sleep`.                                                                                                                                  |
...
| **[prompts/](prompts/)**                                         | Reusable, agent-neutral task prompts for adding lecture exercises and deriving lab notes. Copy one into any coding agent or invoke its generated command mirror.                                                                                                                                                                                                          |
